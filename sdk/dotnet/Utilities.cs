...
namespace UnMango.Git
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/UnstoppableMango/pulumi-provider-git";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("UnMango.Git.version.txt");
    ...
    internal sealed class GitResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GitResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
