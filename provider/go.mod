module github.com/UnstoppableMango/pulumi-provider-git/provider
...
require (
	...
	github.com/UnstoppableMango/terraform-provider-git v0.0.3 // indirect
...
replace github.com/UnstoppableMango/terraform-provider-git/shim => ./shim
